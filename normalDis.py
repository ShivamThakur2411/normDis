...
print("Mean, Median and mode of MATH SCORE is - {}, {} and {}".format(reading_score_mean, reading_score_median, reading_score_mode))
...
print("Mean, Median and mode of MATH SCORE is - {}, {} and {}".format(writing_score_mean, writing_score_median, writing_score_mode))
